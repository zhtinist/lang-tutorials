...
> 一张 **XMind 风格的可交互思维导图**：根节点向右分叉成各大类算法，每类展开为「题目特征 ⇒ 具体算法子分支」，点叶子直达对应笔记。
> 专治「打家劫舍、最长子序列这类题想不到是 DP」——可展开/折叠、拖拽平移、滚轮缩放。
...
| 专题 | 文件 | 核心内容 |
|------|------|----------|
| 🧭 算法选择思维导图 | [algorithm-decision-map.md](algorithm-decision-map.md) | 看题选算法：可交互思维导图，题目特征 ⇒ 算法 ⇒ 具体子分支 |
